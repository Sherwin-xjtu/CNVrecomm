...
def winDrawLoseAnalysis(RAfile, tag):
    ...
    df.to_csv('F:/CNVrecommendation/newCalling/results/winDrawLose' + tag + '.csv', index=False)

if __name__ == '__main__':

    ra_file = 'F:/CNVrecommendation/newCalling/results/hypothesisTestingP.xlsx'
    tag_type = 'P'
