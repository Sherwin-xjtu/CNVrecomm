...
class StypeDataDglDataset(DGLDataset):
    ...
    def has_cache(self):
        ...
        graph_path = os.path.join(self.save_mydata, 'ST_dgl_graph_{}{}.bin'.format(self.hash, 'StypeData'))
    ...
    def load(self):
        graphs, label_dict = load_graphs(os.path.join(self.save_mydata, 'ST_dgl_graph_{}{}.bin'.format(self.hash, 'StypeData')))
        self.graphs = graphs
