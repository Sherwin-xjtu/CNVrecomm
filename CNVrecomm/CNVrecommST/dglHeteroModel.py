...
from CNVrecomm.CNVrecommST.PtypeDataDglDatasetT import PtypeDataDglDatasetT
from CNVrecomm.CNVrecommST.PtypeDataDglDataset import PtypeDataDglDataset
from CNVrecomm.CNVrecommST.FtypeDataDglDataset import FtypeDataDglDataset
from CNVrecomm.CNVrecommST.FtypeDataDglDatasetT import FtypeDataDglDatasetT
from CNVrecomm.CNVrecommST.StypeDataDglDataset import StypeDataDglDataset
from CNVrecomm.CNVrecommST.StypeDataDglDatasetT import StypeDataDglDatasetT
...
def CNVrecommMainST(tag, pattern):

    dataset1, dataset2 = dataLoad(tag)
    CNVrecommResults = None
    if pattern == 'train':
        CNVrecommModelTrain(dataset1, dataset2, tag)
        print('The train process of CNVrecommST is end!')
        CNVrecommResults = 'The train process of CNVrecommST is end!'
    elif pattern == 'test':
        model_final = 106
        models_path = 'F:/CNVrecommendation/CNVrecomm/models/'
        data_loader = modelDataLoader(dataset1, bats=80)
