...
from CNVrecomm.CNVrecommSTT.metaPathDGLT import extractGraphData
...
class FtypeDataDglDatasetT(DGLDataset):
    ...
    def has_cache(self):
        ...
        graph_path = os.path.join(self.save_mydata, 'STT_dgl_graph_{}{}.bin'.format(self.hash, 'FtypeData'))
    ...
    def load(self):
        graphs, label_dict = load_graphs(os.path.join(self.save_mydata, 'STT_dgl_graph_{}{}.bin'.format(self.hash, 'FtypeData')))
        self.graphs = graphs
