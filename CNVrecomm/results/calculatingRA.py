...
def RAxls(ralist, tag):
    ...
    df.to_excel('F:/CNVrecommendation/newCalling/results/hypothesisTesting' + tag + '.xlsx', index=False)

if __name__ == '__main__':
    ExtractingMetaTargetScarler = 'F:/CNVrecommendation/newCalling/results/ExtractingMetaTargetScarler_Ppre.csv'
