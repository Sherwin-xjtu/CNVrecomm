...
from CNVrecomm.CNVrecommSST.PtypeDataDglDatasetT import PtypeDataDglDatasetT
from CNVrecomm.CNVrecommSST.PtypeDataDglDataset import PtypeDataDglDataset
from CNVrecomm.CNVrecommSST.FtypeDataDglDataset import FtypeDataDglDataset
from CNVrecomm.CNVrecommSST.FtypeDataDglDatasetT import FtypeDataDglDatasetT
from CNVrecomm.CNVrecommSST.StypeDataDglDataset import StypeDataDglDataset
from CNVrecomm.CNVrecommSST.StypeDataDglDatasetT import StypeDataDglDatasetT
...
def CNVrecommMainSST(tag, pattern):
    ...
    if pattern == 'train':
        ...
        print('The train process of CNVrecommSST is end!')
        CNVrecommResults = 'The train process of CNVrecommSST is end!'
    elif pattern == 'test':
        model_final = 106
        models_path = 'F:/CNVrecommendation/CNVrecomm/models/'
        data_loader = modelDataLoader(dataset1, bats=80)
