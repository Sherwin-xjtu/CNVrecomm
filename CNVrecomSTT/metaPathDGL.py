...
class extractGraphData():
    ...
    def dfStandardScaler(self, df_data):
        ...
        df_score.to_csv('/Volumes/MyBook/2023work/CNVrecommendation/newCalling/ExtractingMetaTargetScarler.csv', index=False)
    ...
    def extractNodes(self, df_data):
        sample_nodes_path = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/sample_nodes.csv'
        ...
        sample_nodes_attr_path = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/sample_nodes_attr.csv'
    ...
    def dataPre(self):
        ExtractingMetaTarget = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/ExtractingMetaTarget.tsv'
    ...
    def getDataList(self, tag):
        ...
        meta_dgl_labels = []
        meta_dgl_samples = []
        ####Sample of simulations by Sherwin
        ExtractingMetaTargetScarler = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/ExtractingMetaTargetScarler.csv'
