...
from CNVrecom.CNVrecomSTT.PtypeDataDglDatasetT import PtypeDataDglDatasetT
from CNVrecom.CNVrecomSTT.PtypeDataDglDataset import PtypeDataDglDataset
from CNVrecom.CNVrecomSTT.FtypeDataDglDataset import FtypeDataDglDataset
from CNVrecom.CNVrecomSTT.FtypeDataDglDatasetT import FtypeDataDglDatasetT
from CNVrecom.CNVrecomSTT.StypeDataDglDataset import StypeDataDglDataset
from CNVrecom.CNVrecomSTT.StypeDataDglDatasetT import StypeDataDglDatasetT
...
def CNVrecommMainSTT(tag, pattern):
    ...
    if pattern == 'train':
        ...
        print('The train process of {} of CNVrecomSTT is end!'.format(tag))
        CNVrecommResults = 'The train process of CNVrecomSTT is end!'
    elif pattern == 'test':
        model_final = 106
        models_path = '/Volumes/MyBook/2023work/CNVrecommendation/CNVrecomResults/models/'
        data_loader = modelDataLoader(dataset1, bats=80)
