...
class extractGraphData():
    ...
    def getDataList(self, tag):
        ...
        for sindex, srow in ExtractingMetaTargetScarler_df.iterrows():
            S_T_T_0, S_T_T_label0, S_T_T_samples_id0 = self.STTmetaPath(sindex, srow, tool_nodes_df, tag)
            S_T_T = S_T_T + S_T_T_0
            S_T_T_label = S_T_T_label + S_T_T_label0
            S_T_T_samples_id = S_T_T_samples_id + S_T_T_samples_id0

        meta_dgls = S_T_T
        meta_dgl_labels = S_T_T_label
        meta_dgl_samples = S_T_T_samples_id
