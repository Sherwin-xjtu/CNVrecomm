...
class PtypeDataDglDataset(DGLDataset):
    ...
    def has_cache(self):
        ...
        graph_path = os.path.join(self.save_mydata, '{}_ST_dgl_graph_{}{}.bin'.format(self.sampleid, self.hash, 'PtypeData'))
    ...
    def load(self):
        graphs, label_dict = load_graphs(os.path.join(self.save_mydata, '{}_ST_dgl_graph_{}{}.bin'.format(self.sampleid, self.hash, 'PtypeData')))
        self.graphs = graphs
