...
class StypeDataDglDataset(DGLDataset):
    ...
    def has_cache(self):
        ...
        graph_path = os.path.join(self.save_mydata, '{}_ST_dgl_graph_{}{}.bin'.format(self.sampleid, self.hash, 'StypeData'))
    ...
    def load(self):
        graphs, label_dict = load_graphs(os.path.join(self.save_mydata, '{}_ST_dgl_graph_{}{}.bin'.format(self.sampleid, self.hash, 'StypeData')))
        self.graphs = graphs
