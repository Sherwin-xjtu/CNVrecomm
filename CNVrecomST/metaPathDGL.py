...
class extractGraphData():
    ...
    def extractNodes(self, df_data):
        sample_nodes_path = self.workdir + 'sample_nodes.csv'
        # tool_nodes_path = 'F:/CNVrecommendation/newCalling/tool_nodes.csv'

        tool_nodes_path = self.workdir + 'toolNodes.csv'
        tool_nodescarler_path = self.workdir + 'tool_nodes_attr.csv'
        sample_nodes_attr_path = self.workdir + 'sample_nodes_attr.csv'
    ...
    def dataPre(self):
        # ExtractingMetaTarget = self.workdir + '/data/ExtractingMetaTarget.tsv'
        ExtractingMetaTargetScarler = self.workdir + 'ExtractingMetaTargetScarler.csv'
    ...
    def getDataList(self, tag):
        ...
        ExtractingMetaTargetScarler = self.workdir + 'ExtractingMetaTargetScarler.csv'
        tool_nodes_path = self.workdir + 'toolNodesScarler.csv'
        ExtractingMetaTargetScarler_df = pd.read_csv(ExtractingMetaTargetScarler, encoding='gbk', low_memory=False)
        tool_nodes_df = pd.read_csv(tool_nodes_path, encoding='gbk', low_memory=False)
