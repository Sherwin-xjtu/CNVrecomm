...
from CNVrecomST.metaPathDGLT import extractGraphData
...
class PtypeDataDglDatasetT(DGLDataset):
    ...
    def has_cache(self):
        ...
        graph_path = os.path.join(self.save_mydata, 'ST_dgl_graph_{}{}.bin'.format(self.hash, 'PtypeData'))
    ...
    def load(self):
        graphs, label_dict = load_graphs(os.path.join(self.save_mydata, 'ST_dgl_graph_{}{}.bin'.format(self.hash, 'PtypeData')))
        self.graphs = graphs
