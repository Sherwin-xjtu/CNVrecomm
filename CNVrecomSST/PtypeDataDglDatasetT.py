...
class PtypeDataDglDatasetT(DGLDataset):
    def __init__(self, seed=0,save_graph=True):
        ...
        super(PtypeDataDglDatasetT, self).__init__(name="PtypeDataDglDatasetT")
    ...
    def has_cache(self):
        ...
        graph_path = os.path.join(self.save_mydata, 'SST_dgl_graph_{}{}.bin'.format(self.hash, 'PtypeData'))
    ...
    def load(self):
        graphs, label_dict = load_graphs(os.path.join(self.save_mydata, 'SST_dgl_graph_{}{}.bin'.format(self.hash, 'PtypeData')))
        self.graphs = graphs
