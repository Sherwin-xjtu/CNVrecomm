...
from CNVrecom.CNVrecomST.recommendation.SimilarityCalculation import Similarity
...
class extractGraphData():
    ...
    def extractToolNodes(self, tool_nodes_path):
        ...
        df_score.to_csv('/Volumes/MyBook/2023work/CNVrecommendation/newCalling/toolNodesScarler.csv', index=False)
    ...
    def dfStandardScaler(self, df_data):
        ...
        df_score.to_csv('/Volumes/MyBook/2023work/CNVrecommendation/exomeData/ExtractingMetaFeatures/ExtractingMetaTargetScarler.csv', index=False)
    ...
    def extractNodes(self, df_data):
        sample_nodes_path = '/Volumes/MyBook/2023work/CNVrecommendation/exomeData/ExtractingMetaFeatures/sample_nodes.csv'
        # tool_nodes_path = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/tool_nodes.csv'

        tool_nodes_path = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/toolNodes(new1).csv'
        tool_nodescarler_path = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/toolNodesScarler.csv'
        sample_nodes_attr_path = '/Volumes/MyBook/2023work/CNVrecommendation/exomeData/ExtractingMetaFeatures/sample_nodes_attr.csv'
    ...
    def dataPre(self):
        ExtractingMetaTarget = '/Volumes/MyBook/2023work/CNVrecommendation/exomeData/ExtractingMetaFeatures/ExtractingMetaTarget.tsv'
        ExtractingMetaTargetScarler = '/Volumes/MyBook/2023work/CNVrecommendation/exomeData/ExtractingMetaFeatures/ExtractingMetaTargetScarler.csv'
    ...
    def getDataList(self, tag):
        self.dataPre()
        ExtractingMetaTargetScarler = '/Volumes/MyBook/2023work/CNVrecommendation/exomeData/ExtractingMetaFeatures/ExtractingMetaTargetScarler.csv'
        tool_nodes_path = '/Volumes/MyBook/2023work/CNVrecommendation/newCalling/toolNodesScarler.csv'
        ...
        for sindex, srow in ExtractingMetaTargetScarler_df.iterrows():
            S_S_T_0, S_S_T_label0, S_S_T_samples_id0 = self.SSTmetaPath(sindex, srow, ExtractingMetaTargetScarler_df,
                                                                        tool_nodes_df, tag)
            S_S_T = S_S_T + S_S_T_0
            S_S_T_label = S_S_T_label + S_S_T_label0
            S_S_T_samples_id = S_S_T_samples_id + S_S_T_samples_id0

        meta_dgls = S_S_T
        meta_dgl_labels = S_S_T_label
        meta_dgl_samples = S_S_T_samples_id
...
if __name__ == '__main__':
    b = extractGraphData()
    tag = 'S'
    S_T, label, samples = b.getDataList(tag)
    print(S_T, label)
    exit()
