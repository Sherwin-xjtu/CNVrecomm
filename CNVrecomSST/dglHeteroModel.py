...
from CNVrecom.CNVrecomSST.PtypeDataDglDatasetT import PtypeDataDglDatasetT
from CNVrecom.CNVrecomSST.PtypeDataDglDataset import PtypeDataDglDataset
from CNVrecom.CNVrecomSST.FtypeDataDglDataset import FtypeDataDglDataset
from CNVrecom.CNVrecomSST.FtypeDataDglDatasetT import FtypeDataDglDatasetT
from CNVrecom.CNVrecomSST.StypeDataDglDataset import StypeDataDglDataset
from CNVrecom.CNVrecomSST.StypeDataDglDatasetT import StypeDataDglDatasetT
...
def splitTrainSet(dataset1):
    ...
    train_size = int(len(tv_dataset) * 3.4e-04)
...
def CNVrecommMainSST(tag, pattern):
    ...
    if pattern == 'train':
        ...
        print('The train process of {} of CNVrecomSST is end!'.format(tag))
        CNVrecommResults = 'The train process of CNVrecomSST is end!'
    elif pattern == 'test':
        model_final = 106
        models_path = '/Volumes/MyBook/2023work/CNVrecommendation/CNVrecomResults/models/'
        data_loader = modelDataLoader(dataset1, bats=80)
...
if __name__ == '__main__':
    ...
    CNVrecommMainSST(meta_tag, CNVrecomm_pattern)
