...
from CNVrecom.CNVrecomSST.metaPathDGL import extractGraphData

__all__ = ['PtypeDataDglDataset']
...
class PtypeDataDglDataset(DGLDataset):
    def __init__(self, seed=0,save_graph=True):

        self.seed = seed
        self.save_graph = save_graph
        self.save_mydata = '/Volumes/MyBook/DATA/CNVrecommendData/'
        super(PtypeDataDglDataset, self).__init__(name="PtypeDataDglDataset")
